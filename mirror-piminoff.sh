...
echo "Используется зеркало файло-хранилища Piminoff Dev"
...
cd $SRC_DIR
wget http://files.javaph.ru/utils/binutils-2.42.tar.gz
wget http://files.javaph.ru/utils/gcc-13.2.0.tar.gz
